...
class gui_main(wx.Frame):
    def __init__(self, parent, id, title):
        wx.Frame.__init__(self, parent, id, title,size=(mainPanelWidth,mainPanelLength))
        ...
        self.t1_1_1=wx.StaticText(self.panel1_1,-1,'Username:',(mainPanelWidth/2-100,mainPanelLength/2 - 150))
        self.in_username=wx.TextCtrl(self.panel1_1, -1, '', (mainPanelWidth/2, mainPanelLength/2 -150))
        self.t1_1_2=wx.StaticText(self.panel1_1,-1,'Password:',(mainPanelWidth/2-100,mainPanelLength/2-100))
        self.in_passwd=wx.TextCtrl(self.panel1_1,-1,'',(mainPanelWidth/2,mainPanelLength/2-100))
        self.b1_1_1=wx.Button(self.panel1_1,1,'Login',(mainPanelWidth/2-50,mainPanelLength/2-50))
        self.Bind(wx.EVT_BUTTON,self.OnLogin,id=1)
        self.b1_1_2=wx.Button(self.panel1_1,2,'Initialize',(mainPanelWidth/2-50,mainPanelLength/2-50))
        self.Bind(wx.EVT_BUTTON,self.OnInitialize,id=2)
        self.t1_1_3=wx.StaticText(self.panel1_1,-1,'Incorrect Username or Password',(mainPanelWidth/2-100,(mainPanelLength/2)))
        self.t1_1_3.Show(False)
        self.b1_1_2.Show(False)

        self.panel1_2=wx.Panel(self.tabbed1,-1)
        self.tabbed2=wx.Notebook(self.panel1_2, -1, style=(wx.NB_LEFT),size=(mainPanelWidth,mainPanelLength))
