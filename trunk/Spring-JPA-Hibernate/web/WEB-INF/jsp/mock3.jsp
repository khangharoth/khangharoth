		...
		<center>
			...
			<div style="width: 900px;background:white;min-height: 550px">
				<table>
							...
							<td style="width: 100px; font-size: 15px; padding-left:19px;padding: 5px; background:url('images/img05.png') no-repeat;">Commercial</td>
								...
								<tr>
									...
									<td>
										...
										List View
										<input type="radio" value="2" checked="" name="view" />
										Map View
									</td>
								</tr>
								<tr>
									...
									<td align="right" style="font-size: 15px;">
										<div style="border: 1px solid white; width: 70px; text-align:center; background: black;color: white;">
											<a href="mock1.html" style="color: white"> Search </a>
										</div>
									</td>
								</tr>
								<tr>
					...
					<tr>
						<td colspan="3">
							<table id="mapTable" width="100%" cellspacing="1" cellpadding="1" border="0" class="infoBox" style="margin-top: 0px;height: 500px;width:890px;">
								<tbody>
...
//        createMarker(map,new GLatLng(28.578938, 77.165053), '<table cellpadding="0" cellspacing="0" border="0" class="PropertyToolTip"  style="background-color: white;"><tr><td align="left">Click On the image to select licality</td></tr></table>', 'india-new-delhi-innatdelhi.html', 225, icon); 		
		createMarker(map,new GLatLng(28.5679364013242, 77.2758004760752), '<table cellpadding="0" cellspacing="0" class="PropertyToolTip"  style="background-color: white;border:1px solid gray"><tr><td align="left"><img width="80" height="80" src="images/home1.gif" /></td><td width="100%" style="padding-left:5px" valign="top" align="left"><strong>Property Name 1</strong><br />Rent: 20000 Rs<br /> click Here for more <a >Details</a></td></tr></table>','india-new-delhi-royalbedandbreakfastnewdelhi-page.html', 225, icon); 
		createMarker(map,new GLatLng(28.5879364013243, 77.2658004760753), '<table cellpadding="0" cellspacing="0" class="PropertyToolTip"  style="background-color: white;border:1px solid gray"><tr><td align="left"><img width="80" height="80" src="images/home1.gif" /></td><td width="100%" style="padding-left:5px" valign="top" align="left"><strong>Property Name 2</strong><br />Rent: 25000 Rs<br /> click Here for more <a >Details</a></td></tr></table>','india-new-delhi-royalbedandbreakfastnewdelhi-page.html', 226, icon); 
		createMarker(map,new GLatLng(28.5279364013254, 77.2558004760754), '<table cellpadding="0" cellspacing="0" class="PropertyToolTip"  style="background-color: white;border:1px solid gray"><tr><td align="left"><img width="80" height="80" src="images/home1.gif" /></td><td width="100%" style="padding-left:5px" valign="top" align="left"><strong>Property Name 3</strong><br />Rent: 15000 Rs<br /> click Here for more <a >Details</a></td></tr></table>','india-new-delhi-royalbedandbreakfastnewdelhi-page.html', 227, icon); 
		createMarker(map,new GLatLng(28.5479364013245, 77.2658004760755), '<table cellpadding="0" cellspacing="0" class="PropertyToolTip"  style="background-color: white;border:1px solid gray"><tr><td align="left"><img width="80" height="80" src="images/home1.gif" /></td><td width="100%" style="padding-left:5px" valign="top" align="left"><strong>Property Name 4</strong><br />Rent: 12000 Rs<br /> click Here for more <a >Details</a></td></tr></table>','india-new-delhi-royalbedandbreakfastnewdelhi-page.html', 228, icon); 
		createMarker(map,new GLatLng(28.4879364013246, 77.2658004760756), '<table cellpadding="0" cellspacing="0" class="PropertyToolTip"  style="background-color: white;border:1px solid gray"><tr><td align="left"><img width="80" height="80" src="images/home1.gif" /></td><td width="100%" style="padding-left:5px" valign="top" align="left"><strong>Property Name 5</strong><br />Rent: 22000 Rs<br /> click Here for more <a >Details</a></td></tr></table>','india-new-delhi-royalbedandbreakfastnewdelhi-page.html', 229, icon); 
